        ...
        <div className="min-h-screen bg-slate-50 px-6 py-8">
            <div className="mx-auto max-w-3xl">
                ...
                <div className="mb-6 inline-flex items-center gap-2 px-3 py-2">
                    <div className="h-[18px] w-[18px] animate-pulse rounded-md bg-slate-200" />
                    <div className="h-4 w-24 animate-pulse rounded-lg bg-slate-200" />
                </div>

                {/* Header Skeleton */}
                <div className="mb-8 flex items-center gap-4">
                    <div className="h-16 w-16 flex-shrink-0 animate-pulse rounded-3xl bg-slate-200" />
                    ...
                    <div className="divide-y divide-slate-100">
                        ...
                        <div className="flex w-full items-center justify-between p-5">
                            <div className="flex items-center gap-3">
                                ...
                                <div className="h-4 w-44 animate-pulse rounded-lg bg-slate-200" />
                            </div>
